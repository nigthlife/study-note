...
![image-20210516220816818](.\typora-user-images\image-20210516220816818.png)
...
![image-20210516222345701](.\typora-user-images\image-20210516222345701.png)
...
![image-20210516222701671](.\typora-user-images\image-20210516222701671.png)
...
![image-20210519210805714](.\typora-user-images\image-20210519210805714.png)
...
![image-20210519212510909](.\typora-user-images\image-20210519212510909.png)
...
![image-20210519212904729](.\typora-user-images\image-20210519212904729.png)
...
1. - 直接调用RedisSerializer的静态方法来返回序列化器，然后set
   ...
   - 自己new 相应的实现类，然后set
   - ![image-20210519213011690](.\typora-user-images\image-20210519213011690.png)
...
![image-20210519213425110](.\typora-user-images\image-20210519213425110.png)

可以使用 include 组合多个配置问题

![image-20210519213443138](.\typora-user-images\image-20210519213443138.png)

网络配置

![image-20210519213513686](.\typora-user-images\image-20210519213513686.png)

日志输出级别

![image-20210519213546237](.\typora-user-images\image-20210519213546237.png)

日志输出文件

![image-20210519213610291](.\typora-user-images\image-20210519213610291.png)
...
![image-20210519213637622](.\typora-user-images\image-20210519213637622.png)

RDB文件相关

![image-20210519213704099](.\typora-user-images\image-20210519213704099.png)

![image-20210519213715249](.\typora-user-images\image-20210519213715249.png)

主从复制

![image-20210519213754740](.\typora-user-images\image-20210519213754740.png)

Security模块中进行密码设置

![image-20210519213819778](.\typora-user-images\image-20210519213819778.png)
...
![image-20210519214136461](.\typora-user-images\image-20210519214136461.png)

![image-20210519214150106](.\typora-user-images\image-20210519214150106.png)
...
![image-20210519214507636](.\typora-user-images\image-20210519214507636.png)
...
![image-20210519214731117](.\typora-user-images\image-20210519214731117.png)
...
![image-20210519214827262](.\typora-user-images\image-20210519214827262.png)
...
![image-20210519214902012](.\typora-user-images\image-20210519214902012.png)

![image-20210519214912343](.\typora-user-images\image-20210519214912343.png)

**bgsave**

`bgsave` 是异步进行，进行持久化的时候，`redis` 还可以将继续响应客户端请求 ；

![image-20210519215422300](.\typora-user-images\image-20210519215422300.png)
...
![image-20210519215758086](.\typora-user-images\image-20210519215758086.png)
...
![image-20210519220239569](.\typora-user-images\image-20210519220239569.png)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：

![image-20210519220301300](.\typora-user-images\image-20210519220301300.png)
...
![image-20210519220430971](.\typora-user-images\image-20210519220430971.png)
...
启动单机多服务集群：![image-20210519220614194](.\typora-user-images\image-20210519220614194.png)
...
![image-20210519220728586](.\typora-user-images\image-20210519220728586.png)

然后主机上也能看到从机的状态：

![image-20210519220749402](.\typora-user-images\image-20210519220749402.png)

我们这里是使用命令搭建，是暂时的，==真实开发中应该在从机的配置文件中进行配置，==这样的话是永久的。

![image-20210519220807550](.\typora-user-images\image-20210519220807550.png)
...
![image-20210520105113999](.\typora-user-images\image-20210520105113999.png)
...
![image-20210520105205914](.\typora-user-images\image-20210520105205914.png)
...
![image-20210520105238999](.\typora-user-images\image-20210520105238999.png)

此时哨兵监视着我们的主机6379，当我们断开主机后：

![image-20210520105258393](.\typora-user-images\image-20210520105258393.png)
...
![image-20210520105357970](.\typora-user-images\image-20210520105357970.png)

缓存空对象

一次请求若在缓存和数据库中都没找到，就在缓存中方一个空对象用于处理后续这个请求。

![image-20210520105412195](.\typora-user-images\image-20210520105412195.png)
...
![image-20210520105514023](.\typora-user-images\image-20210520105514023.png)
