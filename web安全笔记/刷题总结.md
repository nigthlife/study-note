...
__callStatic()				执行静态对象中的一个不可访问的方法时调用
...
==[sql中的hex是将字符串转为16进制的，同时只要进行2次hex就不会出现类型abc这类字母](https://mayi077.gitee.io/2020/08/18/%E7%BD%91%E9%BC%8E%E6%9D%AF2018-Unfinish/)==
...
-   判断方法
    ...
    -   正常显示推测存在模版注入漏洞
        ...
        -   ```
            ...
            -   ![img](https://pic.downk.cc/item/5ea647a0c2a9a83be5daa329.jpg)
